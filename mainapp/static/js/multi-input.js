class MultiInput extends HTMLElement {
    ...
    ::slotted(div.item) {
      ...
      border: var(--multi-input-border, 1px solid #20c997);
      border-radius: 2px;
      color: #222;
    ...
    <slot></slot>`;
        this.datalistId = this.getAttribute('datalistid')
        this._datalist = document.getElementsByClassName(this.datalistId)[0].options;
        this._allowedValues = [];
        for (const option of this._datalist) {
