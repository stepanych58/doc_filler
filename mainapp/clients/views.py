...
address_factory = modelform_factory(Address, fields=['index',
									...
									widgets={'index': Input(attrs={'class': 'form-control', }),
											 'city': Input(attrs={'class': 'form-control', }),
											 'street': Input(attrs={'class': 'form-control', }),
											 'buildingNumber': Input(attrs={'class': 'form-control', }),
											 'housing': Input(attrs={'class': 'form-control', }),
											 'structure': Input(attrs={'class': 'form-control', }),
											 'flat': Input(attrs={'class': 'form-control', }),
											 'oblast': Input(attrs={'class': 'form-control', }),
											 'rayon': Input(attrs={'class': 'form-control', }), })
...
bank_detail_factory = modelform_factory(BankDetail, fields=['account_number',
										...
										widgets={
											'account_number': Input(attrs={'class': 'form-control', }),
											'correspondent_account_number': Input(attrs={'class': 'form-control', }),
											'bic': Input(attrs={'class': 'form-control', }),
											'bank_name': Input(attrs={'class': 'form-control', }),
										})
organization_factory = modelform_factory(OrganizationInfo, fields=['full_name',
										 ...
										 widgets={'full_name': Input(attrs={'class': 'form-control', }),
												  'accountent_number': Input(attrs={'class': 'form-control', }),
												  'hr_number': Input(attrs={'class': 'form-control', }),
...
additional_client_info_factory = modelform_factory(AdditionalClientInfo, fields=['product',
												   ...
												   widgets={
													   'product': Select(attrs={'class': 'form-control', },
																		 choices=СREDIT_TYPE_CHOISES),
													   'property': Select(attrs={'class': 'form-control', },
																		  choices=PROPERTY_TYPE),
													   'full_insurance': Select(attrs={'class': 'form-control', },
																				choices=YES_NO_CHOISES),
													   'registration': Select(attrs={'class': 'form-control', },
													   ...
													   'family_status': Select(attrs={'class': 'form-control', },
																			   choices=FAMILY_STATUS_CHOISES),
													   'education_status': Select(attrs={'class': 'form-control', },
																				  choices=EDUCATION_STATUS_CHOISES),
													   'work_expireance': Select(attrs={'class': 'form-control', },
																				 choices=ALL_WORK_EXPIREANCE_CHOISES),
													   'position_category': Select(attrs={'class': 'form-control', },
																				   choices=POSITION_CATEGORY_CHOISES),
													   'work_type': Select(attrs={'class': 'form-control', },
																		   choices=WORK_TYPES),
													   'marriage_contract': Select(attrs={'class': 'form-control', },
																				   choices=YES_NO_CHOISES),
													   'immovable_property': Select(attrs={'class': 'form-control', },
																					choices=IMMOVABLE_PROPERTY_CHOISES),
													   'rezident_of_usa': Select(attrs={'class': 'form-control', },
																				 choices=YES_NO_CHOISES),
													   'rezident_of_other_goverment': Select(
														   attrs={'class': 'form-control', },
														   choices=YES_NO_CHOISES),
													   'foreign_citizen': Select(attrs={'class': 'form-control', },
																				 choices=YES_NO_CHOISES),
													   'additional_work': Select(attrs={'class': 'form-control', },
																				 choices=WORK_TYPES),
													   'additional_work_expireance': Select(
														   attrs={'class': 'form-control', },
														   choices=ALL_WORK_EXPIREANCE_CHOISES),
													   'additional_work_category': Select(
														   attrs={'class': 'form-control', },
														   choices=POSITION_CATEGORY_CHOISES),
